const portfoliodata = {
  companies: {
    ...
    spectrocloud: {
      info: [
        { title: "company", subtitle: "Spectro Cloud" },
        { title: "position", subtitle: "Frontend Engineer Intern" },
        { title: "duration", subtitle: "June 2023 - September 2023" },
        { title: "location", subtitle: "Boston, USA" }
      ],
      skills: [
        {
      ...
      traits: [],
      experience: [
        "Single-handedly migrated open-source Spectro Cloud Documentation website from Gatsby and GraphQL to Docusaurus over a 10-week span by setting deployment pipelines, integrated Algolia search, and achieved a 100 Lighthouse score.",
        "Enhanced the project with optimized search functionality, dark mode, Open API documentation, versioning, and SEO"
      ]
    }
  }
};
